...
%                of a VOI field for a given DRT and plots 
...
%                F is a vertex of minimum closeness centrality
...
inds = cell(ncomp,1);               % global lin. indices of the paths
coords = cell(ncomp,1);             % global voxel coords of the paths
